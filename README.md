...
👉 **Personalized Financial Advice**: Provides detailed financial advice based on user-specific financial data using OpenAI's GPT-4o model.
...
```bash
git clone https://github.com/Aarya01Patil/FinanSmart
cd FinanSmart
```
